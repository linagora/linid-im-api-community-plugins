...
class DslRegistryTest {
  ...
  void testGetDslThrowsWhenUrlMissing() {
    ...
    var ex = assertThrows(IllegalArgumentException.class, () -> registry.getDsl(config));
    assertEquals("Database URL is mandatory", ex.getMessage());
  }
  ...
  void testGetDslThrowsWhenUsernameMissing() {
    ...
    var ex = assertThrows(IllegalArgumentException.class, () -> registry.getDsl(config));
    assertEquals("Database username is mandatory", ex.getMessage());
  }
  ...
  void testGetDslThrowsWhenPasswordMissing() {
    ...
    var ex = assertThrows(IllegalArgumentException.class, () -> registry.getDsl(config));
    assertEquals("Database password is mandatory", ex.getMessage());
  }
