...
class DatabaseProviderPluginE2ETest {
  ...
  private static String jdbcUrl = "jdbc:postgresql://localhost:5433/testdb";
  ...
  static void setupClass() throws SQLException {
    ...
    var crudService = new CrudServiceImpl(taskEngine, dslRegistry);
  ...
  void testCreate_test_table_1() throws IOException, SQLException {
  ...
  void testCreate_test_table_2() throws IOException {
  ...
  void testCreate_test_table_3() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  @Test
  @DisplayName("Test create exceptions")
  ...
  void testDelete_test_table_1() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  void testDelete_test_table_2() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  void testDelete_test_table_3() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  void testUpdate_test_table_1() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  void testUpdate_test_table_2() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  void testUpdate_test_table_3() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  void testFindAll_test_table_1() throws IOException {
    var context = new TaskExecutionContext();
    DynamicEntity entity = DynamicEntityHelper.getEntity("TestTable1.yml");
  ...
  void testFindAll_test_table_2() throws IOException {
    var context = new TaskExecutionContext();
    DynamicEntity entity = DynamicEntityHelper.getEntity("TestTable2.yml");
  ...
  void testFindAll_test_table_3() throws IOException {
    var context = new TaskExecutionContext();
    DynamicEntity entity = DynamicEntityHelper.getEntity("TestTable3.yml");
  ...
  @Test
  @DisplayName("Test patch on table test_table_1")
  void testPatch_test_table_1() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  @Test
  @DisplayName("Test patch on table test_table_2")
  void testPatch_test_table_2() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  @Test
  @DisplayName("Test patch on table test_table_3")
  void testPatch_test_table_3() throws IOException, SQLException {
    var context = new TaskExecutionContext();
  ...
  void testFindById_test_table_1() throws IOException {
    var context = new TaskExecutionContext();
    DynamicEntity entity = DynamicEntityHelper.getEntity("TestTable1.yml");
  ...
  void testFindById_test_table_2() throws IOException, SQLException {
    var context = new TaskExecutionContext();
    DynamicEntity entity = DynamicEntityHelper.getEntity("TestTable2.yml");
  ...
  void testFindById_test_table_3() throws IOException {
    var context = new TaskExecutionContext();
    DynamicEntity entity = DynamicEntityHelper.getEntity("TestTable3.yml");
